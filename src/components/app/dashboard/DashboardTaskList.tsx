...
import { ListChecks, Briefcase, Tractor, Heart, Check } from "lucide-react";
...
export default function DashboardTaskList({ schedule, onToggle }: DashboardTaskListProps) {
